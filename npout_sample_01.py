...
df = pd.read_csv('npout2_data_04.csv', encoding='utf-8', sep='|', skiprows=0, names=['C%s' % (i+1) for i in xrange(218)], dtype={'C1': str, 'C3': str})
# df[df['C3']=='0916727473']
...
df_mg.to_csv('npout2_newData_04.csv', sep='|', mode='w', encoding='utf-8', header=False, index=False)

df = pd.read_csv('D:/python_examples/machine_learning/dataAnalytics/csv/npout2_newData.csv', encoding='utf-8', sep='|', names=['C%s' % (i+1) for i in xrange(222)])
